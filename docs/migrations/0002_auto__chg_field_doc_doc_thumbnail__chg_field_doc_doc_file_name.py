...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Doc.doc_thumbnail'
        db.alter_column('docs', 'doc_thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=2024))

        # Changing field 'Doc.doc_file_name'
        db.alter_column('docs', 'doc_file_name', self.gf('django.db.models.fields.files.FileField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Doc.doc_thumbnail'
        db.alter_column('docs', 'doc_thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Doc.doc_file_name'
        db.alter_column('docs', 'doc_file_name', self.gf('django.db.models.fields.files.FileField')(max_length=100))
